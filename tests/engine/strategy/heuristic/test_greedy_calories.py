...
def test__greedy_calories__when_no_product_fits__returns_none():
    # ARRANGE â€” budget too tight for any product
...
def test__greedy_calories__picks_maximum_feasible_quantity(banana):
    # ARRANGE â€” room for exactly 3 bananas by weight (0.36 kg), 4 by budget ($2.00)
...
def test__greedy_calories__falls_through_to_next_product_when_primary_is_exhausted(banana, chips):
    # ARRANGE
    # chips:  150 / 0.20 = 750 cal/kg  â† higher density, picked first
    # banana: 89  / 0.12 = 741 cal/kg  â† picked second with remaining capacity
    # weight: 0.52 kg â†’ 2 chips (0.40 kg) + 1 banana (0.12 kg) = 0.52 kg âœ“
    # budget: $5.00 â€” not the binding constraint
...
def test__greedy_calories__picks_highest_calorie_density_first(banana, chips):
    ...
    # chips:  150 / 0.20 = 750 cal/kg  â† higher density, should be picked first
